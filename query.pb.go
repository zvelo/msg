...
func (*QueryResultRequest) Descriptor() ([]byte, []int) { return fileDescriptorQuery, []int{0} }

func (m *QueryResultRequest) GetRequestId() string {
	if m != nil {
		return m.RequestId
	}
	return ""
...
func init() {
	proto.RegisterType((*QueryResultRequest)(nil), "zvelo.msg.QueryResultRequest")
...
func (this *QueryResultRequest) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	if !ok {
		...
		if ok {
			...
			return fmt.Errorf("that is not of type *QueryResultRequest")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *QueryResultRequest but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *QueryResultRequest but is not nil && this == nil")
	}
...
func (this *QueryResultRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&msg.QueryResultRequest{")
...
func (m *QueryResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TrackingId) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintQuery(dAtA, i, uint64(len(m.TrackingId)))
		i += copy(dAtA[i:], m.TrackingId)
	}
	if m.Status != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintQuery(dAtA, i, uint64(m.Status.Size()))
...
func (m *QueryURLRequests) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Accept) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintQuery(dAtA, i, uint64(len(m.Accept)))
...
func (m *QueryContentRequests) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Dataset) > 0 {
		dAtA8 := make([]byte, len(m.Dataset)*10)
		var j7 int
		for _, num := range m.Dataset {
			for num >= 1<<7 {
...
var fileDescriptorQuery = []byte{
	...
	,
}
