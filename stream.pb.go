...
func (this *StreamResult) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *StreamParams) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
var fileDescriptorStream = []byte{
	...
	0x96, 0xc2, 0x94, 0x80, 0xb8, 0x4a, 0x89, 0xc1, 0x80, 0xd1, 0xc9, 0xe9, 0xc2, 0x43, 0x39, 0x86,
	...
	0x1c, 0xe3, 0x8b, 0x47, 0x72, 0x0c, 0x1f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0xb0, 0xe2,
	0xb1, 0x1c, 0x63, 0x14, 0x0f, 0xc4, 0xc4, 0x4c, 0xb0, 0xdf, 0x93, 0xd8, 0xc0, 0x9e, 0x36, 0x06,
	0x04, 0x00, 0x00, 0xff, 0xff, 0x33, 0x89, 0x21, 0x8d, 0x32, 0x01, 0x00, 0x00,
}
