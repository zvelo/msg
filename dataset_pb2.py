...
_DATASET = _descriptor.Descriptor(
  ...
  nested_types=[_DATASET_CATEGORIZATION, _DATASET_MALICIOUS, _DATASET_ECHO, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
