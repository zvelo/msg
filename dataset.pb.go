...
func (this *DataSet) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	if c := this.Categorization.Compare(that1.Categorization); c != 0 {
		return c
	}
	if c := this.Adfraud.Compare(that1.Adfraud); c != 0 {
		return c
	}
	if c := this.Keyword.Compare(that1.Keyword); c != 0 {
		return c
	}
	if c := this.Malicious.Compare(that1.Malicious); c != 0 {
		return c
	}
	if c := this.Echo.Compare(that1.Echo); c != 0 {
		return c
	}
	if c := this.Sentiment.Compare(that1.Sentiment); c != 0 {
		return c
	}
	return 0
}
func (this *DataSet_Categorization) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *DataSet_AdFraud) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *DataSet_Sentiment) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *DataSet_Keyword) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *DataSet_Malicious) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
func (this *DataSet_Echo) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
...
var fileDescriptorDataset = []byte{
	...
	,
}
